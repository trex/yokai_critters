...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "yokai_critters", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "yokai_critters";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "yokai_critters", null, { width: 640, height: 480 });
